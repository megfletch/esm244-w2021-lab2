...
### Part 2: ggplot2 customzation & reading in different file types
...
### Part3: Compound figures with 'patchwork'
...
# Use / to put graphs over the other

graph_c <- (graph_a | graph_b) / fish_plot & theme_dark()

graph_c

ggsave(here("fig","graph_c_mf.png"), width = 5, height = 6)
```
